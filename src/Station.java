...
public class Station{
    ...
    private List<String> relatedStations = new ArrayList<String>();
    ...
    public List<String> getRelatedStationName(){
    	for (TrainLine t:trainLines) {
    		List<Station> staList =t.getStations();
    		for (Station s:staList) {
				if(!relatedStations.contains(s.getName())) {
					relatedStations.add(s.getName());
				}
			}
    	}
