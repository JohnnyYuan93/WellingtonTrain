 ...
 *   
 *   in the main:read trainline,loop all train line data; read trainline.data -<key is name: object(name,arralylist(stations),arraylist(serives))>
 *   then read 'Johsonvile_wellington'+'-stations' file., then for each station, add this station into trainline.
 *   
 * 
 */
...
public class TrainLine{
    ...
    //Search whether a certain station in this train Line
    public boolean search(Station station) {
